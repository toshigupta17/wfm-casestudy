    ...
    <FadeIn>
      <div className="mb-12">
        <GlassCard className="mb-12 flex gap-4 p-6 md:p-7">
          ...
          <div>
            <h3 className="mb-2 text-base font-semibold text-slate-900">{firstBullet.title}</h3>
            <p
        ...
        <GlassCard className="relative flex min-h-[420px] flex-col overflow-hidden border-sky-200/80 bg-gradient-to-b from-sky-50/95 via-white to-emerald-50/60 p-5 md:p-6">
          <div className="pointer-events-none absolute -left-10 top-20 h-48 w-48 rounded-full bg-sky-300/25 blur-3xl" aria-hidden />
          <div className="pointer-events-none absolute bottom-10 right-0 h-32 w-32 rounded-full bg-emerald-300/20 blur-3xl" aria-hidden />

          <div className="relative z-[1] mb-5">
            <p className="font-display text-xs font-semibold uppercase tracking-[0.18em] text-sky-800">
              {C.futureSubtitle}
            </p>
            <h3 className="mt-2 font-display text-lg font-semibold text-slate-900 md:text-xl">
              {C.futureTitle}
            </h3>
          ...
          <div className="relative z-[1] mt-4 rounded-xl border border-emerald-200/90 bg-emerald-50/90 px-4 py-3 backdrop-blur-sm">
            <p className="text-[11px] font-semibold uppercase tracking-wider text-emerald-800">
              {C.outcomesLabel}
            </p>
            <p className="mt-1 text-sm font-medium text-emerald-950/90">
              {C.outcomes}
            </p>
          </div>

          <div className="relative z-[1] mt-4 border-t border-slate-200/80 pt-4">
            <span className="inline-flex w-full justify-center rounded-lg border border-emerald-200/90 bg-emerald-100/80 py-2 text-center font-display text-xs font-semibold uppercase tracking-[0.12em] text-emerald-900">
              {C.futureBar}
            </span>
          </div>
        </GlassCard>
